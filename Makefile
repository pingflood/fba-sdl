...
CXXFLAGS += -D__cdecl="" -D__fastcall="" -Wno-narrowing
...
$(NAME):	$(allobj)
	...
	@mkdir -p fbasdl/skin
	@$(LD) $(CFLAGS) $(LDFLAGS) -o fbasdl/$@ $^ $(lib)
	@cp src/sdl-dingux/skin/*.png fbasdl/skin/
endif

ipk: all
	@rm -rf /tmp/.fbasdl-ipk/ && mkdir -p /tmp/.fbasdl-ipk/root/home/retrofw/emus/fbasdl /tmp/.fbasdl-ipk/root/home/retrofw/apps/gmenu2x/sections/emulators /tmp/.fbasdl-ipk/root/home/retrofw/apps/gmenu2x/sections/emulators.systems
	@cp -r bin/skin bin/fbasdl.dge bin/fbasdl.png bin/aliases.txt /tmp/.fbasdl-ipk/root/home/retrofw/emus/fbasdl
	@cp bin/fbasdl.lnk /tmp/.fbasdl-ipk/root/home/retrofw/apps/gmenu2x/sections/emulators
	@cp bin/cps1.fbasdl.lnk bin/cps2.fbasdl.lnk bin/neogeo.fbasdl.lnk /tmp/.fbasdl-ipk/root/home/retrofw/apps/gmenu2x/sections/emulators.systems
	@sed "s/^Version:.*/Version: $$(date +%Y%m%d)/" bin/control > /tmp/.fbasdl-ipk/control
	@cp bin/conffiles bin/postinst /tmp/.fbasdl-ipk/
	@tar --owner=0 --group=0 -czvf /tmp/.fbasdl-ipk/control.tar.gz -C /tmp/.fbasdl-ipk/ control conffiles postinst
	@tar --owner=0 --group=0 -czvf /tmp/.fbasdl-ipk/data.tar.gz -C /tmp/.fbasdl-ipk/root/ .
	@echo 2.0 > /tmp/.fbasdl-ipk/debian-binary
	@ar r bin/fbasdl.ipk /tmp/.fbasdl-ipk/control.tar.gz /tmp/.fbasdl-ipk/data.tar.gz /tmp/.fbasdl-ipk/debian-binary
...
$(a68k.o):	fba_make68k.c
	...
	$(objdir)dep/generated/fba_make68k $(@:.o=.s) $(@D)/a68ktbl.inc
...
%.o:	%.s
	...
	# @$(CC) $(CFLAGS) -mabicalls -c -o $(subst $(srcdir),$(objdir),$(<D))/$(@F) $<
...
opk: all
	@mksquashfs \
	fbasdl/default.retrofw.desktop \
	fbasdl/skin \
	fbasdl/fbasdl.dge \
	fbasdl/fbasdl.png \
	fbasdl/aliases.txt \
